    ...
    <section class="common-back" id="wrapBackground">
      <header id="header">
        <div class="common-width clearfix">
          <h1 class="fl">
            <a class="logo base-logo" href="index.html">外卖超人</a></h1>
          <ul class="member" login-box>
            <li>
              <a href="index.html" class="index">首页</a></li>
            <li class="login-register">
              <a href="login.html" referer-url class="login" rel="nofollow">登录</a>
              <span class="cg">/</span>
              <a href="register.html" referer-url rel="nofollow" class="register">注册</a></li>
            <li>
              <a href="member_order.html" class="order-center" rel="nofollow">查看订单</a></li>
            <li class="">
              <a href="gifts.html" rel="nofollow">氪星礼品站</a></li>
            <li class="phone-client ">
...
<?php if(is_array($list)): foreach($list as $m=>$im): ?><div id="menu-main" class="menu-main">
                ...
                <div class="menu-cart">
                  ...
                  <section>
                    <div class="inner-cart empty" ng-class="{empty:isEmpty}">
                          ...
                          <div class="cart-item cart-data clearfix" ng-repeat="obj in cartDatas">
                            ...
                            <div class="accessory-item" ng-class="{firstitem:$first}" ng-repeat="item in obj.options">
                              <div class="cart-item clearfix">
                                ...
                                <div class="goods-price">￥
                                  <span ng-bind="item.price|number:2"></span></div>
                                <div class="goods-subtotal">￥
                                  <span ng-bind="(item.price * item.quantity)|number:2"></span></div>
                              </div>
                            </div>
                          </div>
                          <!--附加物-->
                      ...
                      <div class="checkout">
                        <button class="checkout btn" ng-disabled="isPlaceOrder" ng-click="createOrder()" ng-bind="createOrderBtnName">立即下单</button></div>
                    </div>
                  </section>
                </div>
    ...
    <script>var common_sms_code = '/ajax/1111111111/';
      var ajax_customer_user_register_start = '/ajax/22222222222222/';//注册路径
      var common_validate_sms_code = '/ajax/3333333333333333/';
      var ajax_customer_user_register_register = '/ajax/444444444444/';</script>
    ...
    <script>var feedbackUrl = '/ajax/feedback/';//反馈意见
...
for(var j=0; j<jsons[i].product.length; j++)  
    ...
    console.log(sections);
      ...
      var create_order_url = "<?php echo U('Index/index3');?>";
      var checkout_url = "";
