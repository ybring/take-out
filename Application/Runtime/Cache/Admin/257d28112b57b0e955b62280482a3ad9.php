...
<body>
<div class="page-container"><!--action="pictured_add_cp_in"-->
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<div class="uploader-list-container">
					<input type="file" id="photo" name="photo" class="input-text radius">
				</div>
			</div>
		</div>
		<div class="row cl">
			<div class="col-xs-8 col-sm-9 col-xs-offset-4 col-sm-offset-2">
				<input  class="btn btn-primary radius" id="cl" type="submit" value="添加商品"></input>
...
function cl()
{
	...
	var data ={'name':name,'type_id':type_id,'price':price,};
	
	$.post('pictured_add_cp_in',data,function(data){
