	...
	<form action="" method="post" class="form form-horizontal" id="form-member-add">
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input  maxlength="11" type="text" class="input-text" value="<?php echo ($phone); ?>" placeholder="" id="phone" name="phone">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>密码：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="password"  maxlength="18" class="input-text" value="<?php echo ($password); ?>" placeholder="" id="password" name="password">
			</div>
		</div>
		<div class="row cl">
