...
<link href="/waimai/Public/Backstage/static/h-ui.admin/css/H-ui.admin.css" rel="stylesheet" type="text/css" />
<!--[if IE 6]>
...
<section class="container-fluid page-404 minWP text-c">
	...
	<p class="error-info">您可以：
		...
		<a href="<?php echo U('Login/index');?>" class="c-primary ml-20">去首页 &gt;</a>
	</p>
</section>
</body>
</html>