...
<!--[if lt IE 9]>
<script type="text/javascript" src="/waimai/Public/lib/html5shiv.js"></script>
<script type="text/javascript" src="/waimai/Public/lib/respond.min.js"></script>
<![endif]-->
<!--[if lt IE 9]>
...
<![endif]-->
<!--[if IE 6]>
<script type="text/javascript" src="/waimai/Public/lib/DD_belatedPNG_0.0.8a-min.js" ></script>
<script>DD_belatedPNG.fix('*');</script>
<![endif]-->
...
<header class="navbar-wrapper">
	<div class="navbar navbar-fixed-top">
		<div class="container-fluid cl"> 
			<a class="logo navbar-logo f-l mr-10 hidden-xs" href="index">沙漏外卖后台管理</a> <a class="logo navbar-logo-m f-l mr-10 visible-xs" href="index">沙漏后台</a>
				...
				<ul class="cl">
					...
					<li class="dropDown dropDown_hover">
						...
						<ul class="dropDown-menu menu radius box-shadow">
							...
							<li><a href="<?php echo U('/Admin/Login/change_password');?>">修改密码</a></li>
							<li><a href="<?php echo U('/Admin/Login/login_out');?>">安全退出</a></li>
					</ul>
				</li>
...
<aside class="Hui-aside">
	<div class="menu_dropdown bk_2">
		<dl id="menu-article">
			<dt><i class="Hui-iconfont">&#xe616;</i>外卖分类<i class="Hui-iconfont menu_dropdown-arrow">&#xe6d5;</i></dt>
			<dd>
				<ul>
					<li><a data-href="<?php echo U('/Admin/Type/index');?>" data-title="分类管理" href="javascript:void(0)">分类管理</a></li>
					<li><a data-href="<?php echo U('/Admin/Type/type_add');?>" data-title="添加分类" href="javascript:void(0)">添加分类</a></li>
				</ul>
			</dd>
		</dl>
		<dl id="menu-product">
			...
			<dd>
				<ul>
					...
					<li><a data-href="<?php echo U('Product/product_add_cp');?>" data-title="添加产品" href="javascript:void(0)">添加产品</a></li>
				</ul>
			</dd>
		</dl>
		<dl id="menu-product">
			...
			<dd>
				<ul>
					<li><a data-href="<?php echo U('/Admin/Order/index');?>" data-title="品牌管理" href="javascript:void(0)">订单管理</a></li>
		...
		<dl id="menu-comments">
			...
			<dd>
				<ul>
					<li><a data-href="<?php echo U('/Admin/Feedback/index');?>" data-title="意见反馈" href="javascript:void(0)">意见反馈</a></li>
				</ul>
			</dd>
		</dl>
		<dl id="menu-member">
...
<script type="text/javascript" src="/waimai/Public/Backstage/lib/jquery.contextmenu/jquery.contextmenu.r2.js"></script>
<!--_footer 作为公共模版分离出去-->
