...
//		$_SESSION['mobile'] = $mobile;
//		$_SESSION['mobile_code'] = $mobile_code;dump($_SESSION['mobile_code']);exit();
	...
	public function pwd_reset_do(){
		if(session('mobile')){
			$mobile=session('mobile');
			$pass=I('post.pass');
			$password=password_hash($pass,PASSWORD_DEFAULT);
			$users=M('users');
			$code = $users->where(array('phone'=>$mobile))->save(array('password'=>$password));
			$this->ajaxReturn($code);exit();
		}
